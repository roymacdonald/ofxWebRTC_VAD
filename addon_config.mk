...
meta:
	ADDON_NAME = ofxWebRTC_VAD
	ADDON_DESCRIPTION = ofxWebRTC_VAD
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "WebRTC_VAD" "Voice Activity Detection"
	ADDON_URL = http://github.com/roymacdonald/ofxWebRTC_VAD
